...
public class StatValues
{
    ...
    public static List<Upgrade> SwimSpeedLevels = new List<Upgrade> { new Upgrade(2.5f, 0, 0, 0, true), new Upgrade(3.2f, 10, 10, 10), new Upgrade(4.0f, 25, 25, 25), new Upgrade(5.0f, 40, 40, 40) };
